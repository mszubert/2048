...
public final class TypeResolver {
	...
	/**
	 * Returns the raw class representing the type argument for the {@code type} using type variable information from
	 * the {@code subType}. If no arguments can be resolved then {@code Unknown.class} is returned.
	 * 
	 * @param type
	 *            to resolve argument for
	 * @param subType
	 *            to extract type variable information from
	 * @return type argument for {@code type} else {@link Unknown.class} if no type arguments are declared
	 * @throws IllegalArgumentException
	 *             if more or less than one type argument is resolved for the {@code type}
	 */
	...
	/**
	 * Returns the raw class representing the type argument for the {@code genericType} using type variable information
	 * from the {@code subType}. If {@code genericType} is an instance of class, then {@code genericType} is returned.
	 ...
	 * @param subType
	 *            to extract type variable information from
	 * @return type argument for {@code genericType} else {@link Unknown.class} if no type arguments are declared
	 * @throws IllegalArgumentException
	 *             if more or less than one type argument is resolved for the {@code genericType}
	 */
	...
	/**
	 * Returns an array of raw classes representing type arguments for the {@code type} using type variable information
	 * from the {@code subType}. Arguments for {@code type} that cannot be resolved are returned as
	 ...
	 * @param subType
	 *            to extract type variable information from
	 * @return array of raw classes representing type arguments for the {@code type} else {@code null} if no type
